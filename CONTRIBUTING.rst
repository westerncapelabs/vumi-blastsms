How to contribute to Vumi BlastSMS
=============================

Vumi BlastSMS is an Open Source software project under the BSD license.
...
2.  Run the tests, we'll only accept pull requests with passing tests.
    Ensure that the tests run with ``trial vxblastsms`` and that you're starting
    with a clean slate.
